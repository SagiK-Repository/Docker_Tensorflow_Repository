...
nvidia-docker run -it --name nvcr.io/nvidia/j7j/dcgm-exporter:3.2.5-3.1.7-ubuntu20.04 -p 18081:8080 -d juhyung1021/tensorflow_gpu_vscode_gitrepo_iamge:latest 
```
